...
const SearchButton = () => (
  <svg className="h-3.5 w-3.5" width="10" height="10" viewBox="0 0 40 40" aria-hidden="true">
...
const SearchBox: FC<SearchBoxProps> = ({ placeholder, enableQuerySyntax = false, clearFilters = false }) => {
  ...
  return (
    <div className="search-form relative mb-4">
      <button
        type="button"
      ...
      <input
        ...
        className="w-full border-none bg-gray-50 px-8 py-2 outline-none placeholder:text-black focus:border-black"
      />
    </div>
  );
};
