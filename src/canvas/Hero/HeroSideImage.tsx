...
export const HeroSideImage: FC<HeroProps> = ({
  ...
  return (
    ...
    >
      <div
        className={classNames("hero-content p-0 text-center", heroContentClass, {
      ...
      >
        ...
        <div className={classNames("z-20 mx-1 flex flex-col text-start md:mx-10", styles?.textAlign)}>
          <ElementWrapper
            duration={duration}
            delay={getDelayValue(0)}
