...
export const PlayButton: FC<PlayButtonProps> = ({ onClick }) => (
  <button
    className="absolute w-1/12 transition hover:scale-90 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
    type="button"
    aria-label="Play Video"
    onClick={onClick}
  >
    <svg className="w-full h-full" width="84" height="84" viewBox="0 0 84 84" fill="none">
      <path
